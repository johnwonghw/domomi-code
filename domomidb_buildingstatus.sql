...
CREATE TABLE `buildingstatus` (
  `idbuldingstatus` int(11) NOT NULL AUTO_INCREMENT,
  `description` varchar(45) DEFAULT NULL,
  `active` smallint(6) DEFAULT NULL,
  PRIMARY KEY (`idbuldingstatus`),
  UNIQUE KEY `idbuldingstatus_UNIQUE` (`idbuldingstatus`)
...
INSERT INTO `buildingstatus` VALUES (1,'Under Construction',1),(2,'Pre Construction',1),(3,'Construction',1),(4,'Completed',1);
...
-- Dump completed on 2016-07-13  9:05:41
